...
export default function DealsLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-[#070b13] text-[#eaf1ff]">
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-[250px] border-r border-[#263653] bg-[#0b1220] lg:flex lg:flex-col">
      <Brand />
      <div className="mx-4 mb-5 rounded-2xl border border-[#31e6a7]/20 bg-[#10251f] p-3"><p className="font-mono text-[10px] uppercase tracking-[.2em] text-[#67efc0]">Mercado EUA</p><p className="mt-1 text-xs text-[#b4c9c5]">Radar em modo demo</p><span className="mt-3 flex items-center gap-2 text-[10px] text-[#6ff0c0]"><i className="size-1.5 rounded-full bg-[#31e6a7] shadow-[0_0_9px_#31e6a7]" /> monitorando ofertas</span></div>
