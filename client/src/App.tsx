...
import { AlertsPage, AppPage, ComparePage, DealsHome, ExtensionPage, LocatorPage, OffersPage, PremiumPage, RankingPage, ShippingPage, WholesalePage } from "./pages/DealsPages";

function Router() {
  return <Switch>
    <Route path="/" component={DealsHome} />
    <Route path="/localizador" component={LocatorPage} />
