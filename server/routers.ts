...
const demoProducts = [
  { id: 1, name: "Sony PlayStation 5 Slim", category: "Eletrônicos", price: "449.99", stock: 24 },
  { id: 2, name: "Apple AirPods Pro 2", category: "Eletrônicos", price: "169.99", stock: 18 },
  { id: 3, name: "Nike Air Max Dn", category: "Moda", price: "89.00", stock: 31 },
  { id: 4, name: "MacBook Air M2 recondicionado", category: "Eletrônicos", price: "699.00", stock: 12 },
];
...
export const appRouter = router({
  ...
  catalog: router({ list: publicProcedure.input(z.object({ category: z.string().optional() }).optional()).query(async ({ input }) => { const dbProducts = await listProducts(); if (dbProducts.length) return dbProducts; return input?.category ? demoProducts.filter(p => p.category === input.category) : demoProducts; }) }),
